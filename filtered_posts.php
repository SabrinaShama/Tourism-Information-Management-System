  ...
  <div class="parallax">
	...
	<div class="main_blog" id="commblog">
		<div class="content">
			<h2 class="content-title">Articles on <u><?php echo getTopicNameById($topic_id); ?></u></h2>
			<hr>
			<p>Oops...You need an account to view our blogs on that topic....Shall we join ? <a href="joinnew.php" target="_blank">Sign up here</a> or just <a href="joinnew.php" target="_blank">Sign in</a></p>
		</div>
	</div>
	<?php } ?>
